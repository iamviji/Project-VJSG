...
public class DataBase {
  ...
  public static int INTR_DETECTION_SIDE_THRESHOLD =300;     /* in cm*/
 // public static int INTR_DETECTION_SIDE_THRESHOLD_2 =200;
  public static int INTR_DETECTION_GATE_THRESHOLD =50;     /* in cm*/
  ...
  public static int PP_PARK_AREA_LENGTH = 600;  /* in cm */
  ...
  public static int PP_VERIFY_ANGLE = 20;
